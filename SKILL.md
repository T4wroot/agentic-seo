...
- **Marketing, Content, or Paid Ads**: If the user asks for broader marketing strategy, content generation, social media plans, or paid ads, silently read the relevant skill files in the `skills/` directory (which contains over 160 native IDE skills).
